...
object TrackRegistry {
    ...
    private fun registerKantoAmbience() {
        ...
        register(MusicContext.AMBIENCE, MusicTrack("kanto_plains_pallet_town", soundEvent("ambience.kanto.plains_pallet_town"), biomeKeys = KANTO_PLAINS, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_route_lavender_somber", soundEvent("ambience.kanto.route_lavender_somber"), biomeKeys = KANTO_PLAINS, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_forest_viridian", soundEvent("ambience.kanto.forest_viridian"), biomeKeys = KANTO_FOREST, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_route_cerulean_transition", soundEvent("ambience.kanto.route_cerulean_transition"), biomeKeys = KANTO_FOOTHILLS, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_cave_mt_moon", soundEvent("ambience.kanto.cave_mt_moon"), biomeKeys = KANTO_CAVE, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_coastal_to_bill", soundEvent("ambience.kanto.coastal_to_bill"), biomeKeys = KANTO_COASTAL, regions = setOf(RegionOfOrigin.KANTO)))
        register(MusicContext.AMBIENCE, MusicTrack("kanto_ocean_the_sea", soundEvent("ambience.kanto.ocean_the_sea"), biomeKeys = KANTO_OCEAN, regions = setOf(RegionOfOrigin.KANTO)))
    ...
    private fun registerJohtoAmbience() {
        ...
        register(MusicContext.AMBIENCE, MusicTrack("johto_plains_route_30", soundEvent("ambience.johto.plains_route_30"), biomeKeys = JOHTO_PLAINS, regions = setOf(RegionOfOrigin.JOHTO)))
        register(MusicContext.AMBIENCE, MusicTrack("johto_plains_new_bark_town", soundEvent("ambience.johto.plains_new_bark_town"), biomeKeys = JOHTO_PLAINS, regions = setOf(RegionOfOrigin.JOHTO)))
        register(MusicContext.AMBIENCE, MusicTrack("johto_route_26_open", soundEvent("ambience.johto.route_26_open"), biomeKeys = JOHTO_PLAINS, regions = setOf(RegionOfOrigin.JOHTO)))
        register(MusicContext.AMBIENCE, MusicTrack("johto_forest_national_park", soundEvent("ambience.johto.forest_national_park"), biomeKeys = JOHTO_FOREST, regions = setOf(RegionOfOrigin.JOHTO)))
        register(MusicContext.AMBIENCE, MusicTrack("johto_forest_ecruteak", soundEvent("ambience.johto.forest_ecruteak"), biomeKeys = JOHTO_FOREST, regions = setOf(RegionOfOrigin.JOHTO)))
        register(MusicContext.AMBIENCE, MusicTrack("johto_cave_union_cave", soundEvent("ambience.johto.cave_union_cave"), biomeKeys = JOHTO_CAVE, regions = setOf(RegionOfOrigin.JOHTO)))
    ...
    private fun registerHoennAmbience() {
        ...
        register(MusicContext.AMBIENCE, MusicTrack("hoenn_plains_route_104", soundEvent("ambience.hoenn.plains_route_104"), biomeKeys = HOENN_PLAINS, regions = setOf(RegionOfOrigin.HOENN)))
        register(MusicContext.AMBIENCE, MusicTrack("hoenn_plains_route_110", soundEvent("ambience.hoenn.plains_route_110"), biomeKeys = HOENN_PLAINS, regions = setOf(RegionOfOrigin.HOENN)))
        register(MusicContext.AMBIENCE, MusicTrack("hoenn_plains_route_120", soundEvent("ambience.hoenn.plains_route_120"), biomeKeys = HOENN_PLAINS, regions = setOf(RegionOfOrigin.HOENN)))
        register(MusicContext.AMBIENCE, MusicTrack("hoenn_plains_littleroot_town", soundEvent("ambience.hoenn.plains_littleroot_town"), biomeKeys = HOENN_PLAINS, regions = setOf(RegionOfOrigin.HOENN)))
        register(MusicContext.AMBIENCE, MusicTrack("hoenn_plains_oldale_town", soundEvent("ambience.hoenn.plains_oldale_town"), biomeKeys = HOENN_PLAINS, regions = setOf(RegionOfOrigin.HOENN)))
    ...
    private fun registerSinnohAmbience() {
        ...
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_route_203", soundEvent("ambience.sinnoh.plains_route_203"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_route_209", soundEvent("ambience.sinnoh.plains_route_209"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_route_210", soundEvent("ambience.sinnoh.plains_route_210"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_route_205", soundEvent("ambience.sinnoh.plains_route_205"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_twinleaf_town", soundEvent("ambience.sinnoh.plains_twinleaf_town"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_plains_sandgem_town", soundEvent("ambience.sinnoh.plains_sandgem_town"), biomeKeys = SINNOH_PLAINS, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_forest_eterna_forest", soundEvent("ambience.sinnoh.forest_eterna_forest"), biomeKeys = SINNOH_FOREST, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_forest_floaroma_town", soundEvent("ambience.sinnoh.forest_floaroma_town"), biomeKeys = SINNOH_FOREST, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_snowy_route_216", soundEvent("ambience.sinnoh.snowy_route_216"), biomeKeys = SINNOH_SNOWY, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_mountain_mt_coronet", soundEvent("ambience.sinnoh.mountain_mt_coronet"), biomeKeys = SINNOH_MOUNTAIN, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_cave_lake_caverns", soundEvent("ambience.sinnoh.cave_lake_caverns"), biomeKeys = SINNOH_CAVE_LUSH, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_cave_oreburgh_mine", soundEvent("ambience.sinnoh.cave_oreburgh_mine"), biomeKeys = SINNOH_CAVE_MINE, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_ocean_lake", soundEvent("ambience.sinnoh.ocean_lake"), biomeKeys = SINNOH_OCEAN, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_end_distortion_world", soundEvent("ambience.sinnoh.end_distortion_world"), biomeKeys = THE_END, regions = setOf(RegionOfOrigin.SINNOH)))
        register(MusicContext.AMBIENCE, MusicTrack("sinnoh_snowy_snowpoint_city", soundEvent("ambience.sinnoh.snowy_snowpoint_city"), biomeKeys = SINNOH_SNOWY, regions = setOf(RegionOfOrigin.SINNOH)))
    }
